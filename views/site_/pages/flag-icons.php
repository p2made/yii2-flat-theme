...
<div id="content-wrapper">
	...
	<section>
		...
		<div class="no-wrap">
			<h1>
				...
				<span class="label label-default"><i class="flag-icon flag-icon-au"></i> AU</span>
				<span class="label label-primary"><i class="flag-icon flag-icon-au"></i> AU</span>
				<span class="label label-success"><i class="flag-icon flag-icon-au"></i> AU</span>
				<span class="label label-info"><i class="flag-icon flag-icon-au"></i> AU</span>
				<span class="label label-warning"><i class="flag-icon flag-icon-au"></i> AU</span>
				<span class="label label-danger"><i class="flag-icon flag-icon-au"></i> AU</span>
			</h1>
			<h2>
				h2
				<i class="flag-icon flag-icon-au"></i>
	...
	</section><!-- / Examples (inline with text) -->
	<section>
		<h2>Examples (on any element)</h2>
		<hr>
		<div class="row">
	...
	</section><!-- / Examples (on any element) -->
	<section>
		<h2>All Flags</h2>
		<hr>
		<div class="row">
